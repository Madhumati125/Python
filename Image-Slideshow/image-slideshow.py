...
class Slider:
    def __init__(self, root):
        ...
        image = Image.open('D:/Python/Image-Slideshow/lakes.png')
        image = image.resize((700, 400), Image.ANTIALIAS)
        self.image1 = ImageTk.PhotoImage(image)
        image = Image.open('D:/Python/Image-Slideshow/mountains.jpg')
        image = image.resize((700, 400), Image.ANTIALIAS)
...
photo = PhotoImage(file="D:/Python/Image-Slideshow/gallery.png")
